...
fighter::fighter(float width, float height, sf::Vector2i mouseposition) {
    ...
    //   return EXIT_FAILURE;
    //}
	chartexture.loadFromFile(resourcePath() + "FighterStandIn.png");
    ...
    //    return EXIT_FAILURE;
    //}
	armtexture.loadFromFile(resourcePath() + "FighterArmStandIn.png");
    ...
    //    return EXIT_FAILURE;
    //}
	swordslashtexture.loadFromFile(resourcePath() + "SwordSlashStandIn.png");
...
void fighter::aim(sf::Vector2i direction){
    ...
    if (aimy > 0) {
        armsprite.setRotation(180*int(asin(-aimx)/3.14159));
    }
    else{
        if (aimy == 0) {
            if (aimx > 0) {
            ...
            armsprite.setRotation(-180*int(asin(-aimx)/3.14159) + 180);
        }
    }
